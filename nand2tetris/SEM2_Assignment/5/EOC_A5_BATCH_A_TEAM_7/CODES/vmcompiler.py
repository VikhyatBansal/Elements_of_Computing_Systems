...
class VMWriter():
    ...
    """
    def __init__(self, input_file):
        self.output_file = open(self.get_vm_file(input_file), 'w')
    ...
    @staticmethod
    def get_vm_file(vm_file):
        """
        Suggests a file name for the Assembly Machine Code source file.
        :param vm_file: Program source code file written in VM Language.
        :return: String.
        """
...
if __name__ == "__main__" and len(sys.argv) == 2:
    ...
    print('ASM file for selected .vm file created')
